...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference("Membership.count") do
      post memberships_url, params: { membership: { players_id: @membership.players_id, teams_id: @membership.teams_id } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { players_id: @membership.players_id, teams_id: @membership.teams_id } }
